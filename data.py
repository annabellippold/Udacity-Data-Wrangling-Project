# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 11:19:34 2017
...
from audit import update_name, update_postcode, update_city, mapping, city_mapping

#OSM_PATH = "sample.osm"
OSM_PATH = "map_sfo.osm"
        ...
        if child.tag == 'tag':
            if problem_chars.match(child.attrib['k']):
                ...
                if 'city' in child.attrib['k']:
                    fields['value'] = update_city(child.attrib['v'], city_mapping)
                else:
                    fields['value'] = child.attrib['v']     
...
##                # --- Cleaning Streetnames
##                #if 'street' in child.attrib['k']:
##                fields['value'] = clean_street_type(child.attrib['v'], mapping)
##                #äelse:
##                  #  fields['value'] = child.attrib['v']
##                
##                # --- Cleaning Postcodes
...
##                # --- Cleaning City
##                #if 'city' in child.attrib['k']:
##                 #   fields['value'] = clean_city_type(child.attrib['v'], city_mapping)
##                #else:
##                 #   fields['value'] = child.attrib['v']
##                    
##                if ':' in child.attrib['k']:
